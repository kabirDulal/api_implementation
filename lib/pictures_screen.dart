...
class PicturesScreen extends StatelessWidget {
  ...
  Future<List<Photos>> getPicturesList() async {
    final response = await http
        .get(Uri.parse('https://api.slingacademy.com/v1/sample-data/photos?offset=5&limit=200'));
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(8),
                                  child: Image.network(snapshot.data![index].url ?? 'https://picsum.photos/200',
                                  fit: BoxFit.cover,
                                  height: 100,
                              ...
                              Text(snapshot.data![index].description ?? 'No description available',
